...
public class GuButton {
    ...
    public GuButton(BitmapFont font, String text, float y) {
        ...
        width = gl.width;
        height = gl.height;
        this.x = Gdx.graphics.getWidth()/2f - width/2;
    ...
    void draw(SpriteBatch batch){
        switch (type){
            ...
            case TYPE_TEXT_CENTER: font.draw(batch, text, 0, y, Gdx.graphics.getWidth(), Align.center, true); break;
    ...
    void setText(String text) {
        ...
        GlyphLayout gl = new GlyphLayout(font, text);
        width = gl.width;
        if(type == TYPE_TEXT_CENTER) x = Gdx.graphics.getWidth()/2f - width/2;
    }
}
